...
<code>; ModuleID = 'math_is_armstrong.c'
source_filename = "math_is_armstrong.c"
...
define dso_local i32 @main() #0 {
  ...
  %6 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i64 0, i64 0))
...
28:                                               ; preds = %24
  ...
  %30 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([28 x i8], [28 x i8]* @.str.2, i64 0, i64 0), i32 noundef %29)
  br label %34

31:                                               ; preds = %24
  %32 = load i32, i32* %5, align 4
  %33 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([32 x i8], [32 x i8]* @.str.3, i64 0, i64 0), i32 noundef %32)
  br label %34
