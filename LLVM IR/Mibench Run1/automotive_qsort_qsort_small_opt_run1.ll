...
<code>; ModuleID = 'automotive_qsort_qsort_small.c'
source_filename = "automotive_qsort_qsort_small.c"
...
define dso_local i32 @compare(i8* noundef %0, i8* noundef %1) #0 {
  ...
  %14 = call i32 @strcmp(i8* noundef %9, i8* noundef %13) #4
...
12:                                               ; preds = %2
  ...
  %14 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %13, i8* noundef getelementptr inbounds ([27 x i8], [27 x i8]* @.str, i64 0, i64 0))
...
15:                                               ; preds = %2
  ...
  %19 = call noalias %struct._IO_FILE* @fopen(i8* noundef %18, i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0))
...
20:                                               ; preds = %33, %15
  ...
  %26 = call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* noundef %21, i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), [128 x i8]* noundef %25)
  %27 = icmp eq i32 %26, 1
...
37:                                               ; preds = %36
  ...
  %39 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([24 x i8], [24 x i8]* @.str.3, i64 0, i64 0), i32 noundef %38)
  ...
  call void @qsort(i8* noundef %41, i64 noundef %43, i64 noundef 128, i32 (i8*, i8*)* noundef @compare)
...
48:                                               ; preds = %44
  ...
  %54 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([4 x i8], [4 x i8]* @.str.4, i64 0, i64 0), i8* noundef %53)
  br label %55
...
declare i32 @__isoc99_fscanf(%struct._IO_FILE* noundef, i8* noundef, ...) #2
