  The LLVM-IR will have instruction count 116 and binary sise 528 bytes:
...
define dso_local i32 @main() #0 {
  ...
  %13 = call i32 (i8*, ...) @scanf(i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* noundef %3)
...
18:                                               ; preds = %14
  %19 = call i32 (i8*, ...) @scanf(i8* noundef getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* noundef %4, i32* noundef %5, i32* noundef %6)
